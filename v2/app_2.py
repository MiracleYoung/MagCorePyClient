...
def reg_player(name, cid):
    ...
    pprint.pprint(f'Register player {name}')
    return res
...
player_name = 'ab'
color = 0
gid = '4dcd688a9e91488f9110d3f756c18f43'


# 'c67354586ce049d5bf93fe52b2f3fcc9'
player = get_player('67c0755ed6d64eca858f7918893d0a22') if reg else reg_player(player_name, color)
